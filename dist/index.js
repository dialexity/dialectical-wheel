...
var WheelRing = function WheelRing(_ref) {
  ...
  var arrowEvents = react.useMemo(function () {
    return segments.map(function (segment) {
      return {
        segmentId: segment.segmentId,
        perspectiveIndex: segment.perspectiveIndex
      ...
      children: [jsxRuntime.jsx("path", {
        ...
        return jsxRuntime.jsxs("g", {
          ...
          children: [jsxRuntime.jsx("path", {
            ...
            strokeLinecap: "round",
            strokeLinejoin: "round"
          }), isDoubleHeaded && jsxRuntime.jsxs(jsxRuntime.Fragment, {
            children: [jsxRuntime.jsx("path", {
...
var CycleRing = function CycleRing(_ref) {
  ...
  var connectingArc = react.useMemo(function () {
  ...
  return jsxRuntime.jsxs("g", {
    children: [connectingArc && jsxRuntime.jsxs("g", {
      opacity: 0.5,
      children: [jsxRuntime.jsx("path", {
        d: connectingArc.d,
        fill: "none",
...
function CalloutInternal(_ref) {
  ...
  return jsxRuntime.jsxs("g", {
    children: [tailElement, jsxRuntime.jsx("g", {
      transform: "rotate(".concat(-rotationDeg, ", ").concat(endX, ", ").concat(endY, ")"),
      children: jsxRuntime.jsx("foreignObject", {
        x: endX - FO_SIZE / 2,
        y: endY - FO_SIZE / 2,
        width: FO_SIZE,
        height: FO_SIZE,
        ...
        children: jsxRuntime.jsx("div", {
          ...
          children: jsxRuntime.jsxs("div", {
            ...
            children: [header && jsxRuntime.jsx("div", {
              style: {
                fontSize: 11,
                lineHeight: 1.3,
                marginBottom: 2
...
function useRotation(_ref) {
  ...
  var isSegmentAtFocusTarget = react.useCallback(function (segmentId) {
  ...
  var isSegmentAtPole = react.useCallback(function (segmentId) {
    var idx = segmentIds.indexOf(segmentId);
  ...
  var refocusWithoutFade = react.useCallback(function (segmentId) {
    var idx = segmentIds.indexOf(segmentId);
    if (idx === -1) return;
    var N = segmentIds.length;
    var segmentAngle = 360 / N;
  ...
  var focusSegmentToPosition = react.useCallback(function (segmentId, targetPosition, clockwise) {
    var idx = segmentIds.indexOf(segmentId);
    if (idx === -1) return;
    var N = segmentIds.length;
    var segmentAngle = 360 / N;
  ...
  var focusSegmentToNextPole = react.useCallback(function (segmentId, clockwise) {
    var idx = segmentIds.indexOf(segmentId);
    if (idx === -1) return;
    var N = segmentIds.length;
    var segmentAngle = 360 / N;
  ...
  var focusSegmentToNearestPole = react.useCallback(function (segmentId) {
    var idx = segmentIds.indexOf(segmentId);
    if (idx === -1) return;
    var N = segmentIds.length;
    var segmentAngle = 360 / N;
  ...
  var rotateBySegments = react.useCallback(function (count) {
...
var Wheel = /*#__PURE__*/react.forwardRef(function Wheel(_ref, ref) {
  ...
  var callouts = react.useMemo(function () {
    var result = [];
    react.Children.forEach(children, function (child) {
      var _child$type;
      if (/*#__PURE__*/react.isValidElement(child) && (_child$type = child.type) !== null && _child$type !== void 0 && _child$type._isWheelCallout) {
  ...
  var handleArrowOver = react.useCallback(function (event) {
    setHoveredArrowId(event.segmentId);
    if (onArrowOver) onArrowOver(event);
  }, [onArrowOver]);
  var handleArrowOut = react.useCallback(function (event) {
    setHoveredArrowId(null);
    if (onArrowOut) onArrowOut(event);
  }, [onArrowOut]);
  var handleArrowClicked = react.useCallback(function (event) {
    if (interactive) {
      var N = segmentIds.length;
    ...
    children: jsxRuntime.jsx("svg", _objectSpread2(_objectSpread2({
      ...
      children: jsxRuntime.jsxs("g", {
        ...
        children: [jsxRuntime.jsx(Ring, {
          ...
          radii: radii,
          segments: ringData.positive
        }), showInwardSpiral && !(interactive && selectedPerspective != null) && jsxRuntime.jsx(InwardSpiralArrows, {
          segments: {
          ...
          return jsxRuntime.jsx("g", {
            ...
            children: jsxRuntime.jsx(CalloutInternal, {
              midAngle: midAngle,
              anchorR: tipR,
