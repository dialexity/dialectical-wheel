...
var dialecticalSlice = createSlice({
  name: 'dialectical',
  ...
  return jsxs("div", {
    ...
    children: [jsx("div", {
      ...
      children: [jsx("div", {
        ...
        children: [jsx("strong", {
          children: "Syntax:"
        }), " Use \"A \u2192 B\" format. Available units: ", Object.keys(dialecticalData).join(', '), jsx("br", {}), jsx("strong", {
          children: "Ring-specific:"
        }), " Add + for positives (e.g., T1+) or - for negatives (e.g., T1-)", jsx("br", {}), jsx("strong", {
          children: "Colors:"
...
function DialecticalWheel() {
  ...
  useEffect(function () {
    ...
    setRuntime(runtime);
    var main = runtime.module(notebook, function (name) {
      if (name === 'chart') {
  ...
  return jsxs("div", {
    ...
    children: [jsx("div", {
      ...
      children: ["Debug: ", Object.keys(dialecticalData).length, " entries in Redux store: ", Object.keys(dialecticalData).join(', '), jsx("br", {}), "Using local npm package: @dialexity/dialectical-wheel"]
    })]
  });
}
  ...
  return jsxs("div", {
    ...
    children: [jsx("h3", {
      ...
      children: [jsx("h4", {
        ...
        children: ["Current T4 statement: ", jsx("strong", {
      ...
      children: [jsxs("h4", {
        children: ["Current Dialectical Data: ", jsx("span", {
          style: {
            fontSize: '12px',
            color: '#666'
          },
...
var SliceAtAngle = function SliceAtAngle(_ref) {
  ...
  if (showBoundaries) {
    ...
    boundaryElements.push(jsx("line", {
      x1: cx,
      y1: cy,
      x2: boundaryX1,
      y2: boundaryY1,
    ...
    }, "".concat(sliceId, "-boundary-1")), jsx("line", {
      x1: cx,
      y1: cy,
      x2: boundaryX2,
      y2: boundaryY2,
...
var useNodeConnections = function useNodeConnections(dynamicSlices, title, recordRef) {
  ...
  var getAllLayerNodes = useCallback(function () {
    return document.querySelectorAll('.layer-node');
  }, []);
  var getLayerNodeById = useCallback(function (nodeId) {
    return document.querySelector("[data-node-id=\"".concat(nodeId, "\"]"));
  }, []);
  var getLayerNodesForPair = useCallback(function (pairIndex) {
    return document.querySelectorAll("[data-pair-index=\"".concat(pairIndex, "\"].layer-node"));
  }, []);
  var getLayerNodesByType = useCallback(function (layerType) {
    return document.querySelectorAll("[data-layer-type=\"".concat(layerType, "\"].layer-node"));
  }, []);
  var getLayerNodeInfo = useCallback(function (nodeElement) {
  ...
  var getNodeCenter = useCallback(function (nodeElement) {
  ...
  var connectNodes = useCallback(function (fromId, toId) {
  ...
  var toggleArrows = useCallback(function () {
  ...
  var createDemoConnections = useCallback(function () {
  ...
  var parseSliceLayerCode = useCallback(function (code) {
  ...
  var getNodeIdFromSliceLayerCode = useCallback(function (code) {
  ...
  var connectNodesBySliceLayerCode = useCallback(function (fromCode, toCode) {
    var color = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '#0074d9';
    var strokeWidth = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 2;
  ...
  var getAvailableSliceLayerCodes = useCallback(function () {
    var codes = [];
  ...
  var parseDotScript = useCallback(function (dotScript) {
    var edges = [];
    var errors = [];
  ...
  var executeDotScript = useCallback(function (dotScript) {
  ...
  var createSliceLayerMappingDemo = useCallback(function () {
    // Give the DOM a moment to render the nodes
    setTimeout(function () {
  ...
  var createDotScriptDemo = useCallback(function () {
    setTimeout(function () {
...
var useWheelSlices = function useWheelSlices(sequenceWithLabels, normalSliceAngle, focusedSliceAngle, unfocusedSliceAngle, rotation, setRotation) {
  ...
  var createSliceLayers = useCallback(function (sliceWidth) {
    var cx = 200,
      cy = 200,
      radius = 150;
  ...
  useCallback(function (centerAngle, sliceWidth, label, pairIndex, sliceType) {
  ...
  var sliceLayersCacheRef = useRef(new Map());
  // Memoize slice layers
  var memoizedCreateSliceLayers = useCallback(function (sliceWidth) {
  ...
  var memoizedSliceData = useMemo(function () {
  ...
  var createEqualSlices = useCallback(function () {
    var slices = [];
  ...
  var focusOnPair = useCallback(function (pairIndex) {
  ...
  var handleSliceClick = useCallback(function (pairIndex) {
  ...
  var handleSliceTouchStart = useCallback(function (e, pairIndex) {
    e.stopPropagation();
  ...
  var handleSliceTouchEnd = useCallback(function (e, pairIndex) {
    e.preventDefault();
    e.stopPropagation();
