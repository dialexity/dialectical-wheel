...
export const Cell: React.FC<CellProps> = ({
  segment, innerR, outerR, textOuterR, textWidthArcR, style, rotationRad, fontSize, textBias, ringNumber, measure, hovered, onClick, onPointerEnter, onPointerLeave, showText = true
}) => {
