...
import { createSliceAtAngle, defaultPairTexts } from './sliceGenerator';
...
const DialecticalWheel = ({ 
  ...
  const [dynamicSlices, setDynamicSlices] = useState([]);
  ...
  const createClickableSlice = (centerAngle, sliceWidth, label, pairIndex, sliceType) => {
